...
namespace pathfinder {
    ...
    // ─── Object Classification (defined BEFORE use) ────────────────────
    ...
    void classifyObject(SimObjectData& obj) {
        ...
        // Initialize portal/speed/gravity defaults
        obj.portalType = 0;
        obj.speedType = -1;
        obj.gravityType = -1;
        obj.padType = -1;
        ...
        // Cube
        if (id == 12 || id == 745) {
            obj.isPortal = true; obj.portalType = 1; obj.height = 60.0; return;
        }
        // Ship
        if (id == 13 || id == 746) {
            obj.isPortal = true; obj.portalType = 2; obj.height = 60.0; return;
        }
        // Ball
        if (id == 47 || id == 747) {
            obj.isPortal = true; obj.portalType = 3; obj.height = 60.0; return;
        }
        // UFO
        if (id == 111 || id == 748) {
            obj.isPortal = true; obj.portalType = 4; obj.height = 60.0; return;
        }
        // Wave
        if (id == 660 || id == 749) {
            obj.isPortal = true; obj.portalType = 5; obj.height = 60.0; return;
        }
        // Robot
        if (id == 750) {
            obj.isPortal = true; obj.portalType = 6; obj.height = 60.0; return;
        }
        // Spider
        if (id == 751) {
            obj.isPortal = true; obj.portalType = 7; obj.height = 60.0; return;
        }
        // Swing (2.2)
        if (id == 1331) {
            obj.isPortal = true; obj.portalType = 8; obj.height = 60.0; return;
        }
        ...
        // === Size Portals ===
        if (id == 99 || id == 101) {
            obj.isPortal = true; obj.height = 60.0; return;
        }
        ...
        // === Solid blocks (broad classification) ===
        ...
        // Anything else: decoration or unknown — non-interactive
    }

    // ─── PathfinderPanel Implementation ────────────────────────────────
